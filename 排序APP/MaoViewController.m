...
@interface MaoViewController ()<UITableViewDelegate,UITableViewDataSource>
...
#pragma mark--------------电源栏字体颜色
    ...
    mode=[ViewManger ShareInstance].ScortArry[3];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *modeArray=[NSArray arrayWithObjects:@"O(n)~O(n^2)",mode.TimeScort,mode.MoveScort,mode.CompScort, nil];    if (indexPath.row ==0)
    {

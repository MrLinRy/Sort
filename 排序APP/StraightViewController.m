...
@interface StraightViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *tableView;

@end

@implementation StraightViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *modeArray=[NSArray arrayWithObjects:@"O(n)~O(n^2)",mode.TimeScort,mode.MoveScort,mode.CompScort, nil];
    if (indexPath.row ==0)
    {
        ...
        if (CellView0 == nil)
        {
            ...
            [labeTime setFont:[UIFont systemFontOfSize:LRYsystemFontOfSize(14)]];

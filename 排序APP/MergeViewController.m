...
@interface MergeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
#pragma mark--------------电源栏字体颜色
    ...
    mode=[ViewManger ShareInstance].ScortArry[5];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *modeArray=[NSArray arrayWithObjects:@"O(nlogn)",mode.TimeScort,mode.MoveScort,mode.CompScort, nil];
    if (indexPath.row ==0)
    {

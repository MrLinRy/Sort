...
@interface QuickViewController ()<UITableViewDelegate,UITableViewDataSource>
...
#pragma mark--------------电源栏字体颜色
    ...
    mode=[ViewManger ShareInstance].ScortArry[1];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *modeArray=[NSArray arrayWithObjects:@"O(nlogn)~O(n^2)",mode.TimeScort,mode.MoveScort,mode.CompScort, nil];    if (indexPath.row ==0)
    {
        ...
        if (CellView0 == nil)
        {
            ...
            UILabel *labeTime =[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(image1.frame)+LRYScreenpW(340),LRYScreenpH(40) , LRYScreenpW(190), LRYScreenpH(40))];
            [labeTime setFont:[UIFont systemFontOfSize:LRYsystemFontOfSize(12)]];

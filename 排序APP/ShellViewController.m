...
@interface ShellViewController ()<UITableViewDelegate,UITableViewDataSource>
...
#pragma mark--------------电源栏字体颜色
    ...
    mode=[ViewManger ShareInstance].ScortArry[2];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *modeArray=[NSArray arrayWithObjects:@"O(n)~O(n^1.3)",mode.TimeScort,mode.MoveScort,mode.CompScort, nil];    if (indexPath.row ==0)
    {
